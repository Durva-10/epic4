class PlayerArrow {
  ...
  display() {
      ...
      for (var i = 0; i < this.trajectory.length; i++) { fill("white"); ellipse(this.trajectory[i][0], this.trajectory[i][1], 5, 5); }
      /****write a correctthis.trajectory.push(position); code to add for loop and to display small dots
